...
type ToolsConfig struct {
	...
	// GenerateImage gates an image-generation tool injected by the host (see
	// seucaranguejo/internal/tools). The tool itself is not implemented here —
	// this entry exists so the host can toggle it per assistant through the
